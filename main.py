...
def update_plot_data(plot_data, amplitude_data, frequency_data, rpm_data, time_data, q, amplitude_queue, frequency_queue, rpm_queue):
    """
...
if __name__ == '__main__':
    ...
    dpg.set_exit_callback(kill_processes, user_data=[p, data_process])

    # below replaces, start_dearpygui()
    while dpg.is_dearpygui_running():
        update_plot_data(data, amplitude_data, frequency_data, rpm_data, time_data, q, amplitude_queue, frequency_queue, rpm_queue)
