...
def update_plot_data(plot_data, q):
    """
    Updates the acoustic plot with the number randomly generated by the other python process
...
def change_view_home():
    """
    Change the main view of the GUI to the home page
    :return:
    """
...
def change_view_rpm():
    """
    Change the main view of the GUI to the rpm page
    :return:
    """
    dpg.configure_item("rpm_page", show=True)
...
def change_view_sound():
    """
    Change the main view of the GUI to the sound page
    :return:
    """
...
def change_view_help():
    """
    Change the main view of the GUI to the help page
    :return:
    """
        ...
        with dpg.child_window(autosize_x=True, autosize_y=True, border=False):
            ...
            with dpg.group(horizontal=True):
                ...
                with dpg.child_window(width=120, autosize_y=True, border=True):
                    ...
                    dpg.add_spacer(height=2)
                    dpg.add_spacer(height=2)
                    dpg.add_image_button("speed_icon", callback=change_view_rpm)
                    dpg.add_spacer(height=2)
                    dpg.add_spacer(height=2)
